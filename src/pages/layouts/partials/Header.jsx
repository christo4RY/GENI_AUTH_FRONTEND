                ...
                <div className='flex lg:space-x-14 xl:space-x-24'>
                    ...
                    <div className='flex space-x-5'>
                        ...
                        <ul className='flex space-x-3 items-center'>
                            <li >
                                <Link to='/' className={` rounded-lg ${scroll ? 'bg-[#57575723] hover:text-white hover:bg-black duration-300 transition-colors' : 'text-white bg-[#ffffff23] hover:bg-black duration-300 transition-colors'} px-4 py-2.5`} >
                                    Sign In
                                </Link>
                            </li>
                            <li >
